  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 flex justify-center">
        <div className="h-64 w-64 rounded-full bg-cyan-500/10 blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-4xl">
        ...
        <p className="mb-6 text-lg leading-relaxed text-gray-300 sm:text-xl">
          ...
          <span className="text-cyan-400">full-stack engineering</span>, and{" "}
          <span className="text-cyan-400">data analytics</span>, focusing on
